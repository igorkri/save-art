<saveart-project-context>
# SaveArt - Краудфандингова платформа для мистецтва

## Огляд проекту
SaveArt — краудфандингова платформа для підтримки мистецтва та митців України.
- Митці створюють проекти та отримують донати
- Меценати підтримують мистецькі проекти
...
- Використовується spatie/laravel-translatable
- JSON поля в БД = translatable

## API
- Публічне: /api/v1/*
- Auth: /api/* (Sanctum)
- Використовуй Form Requests + API Resources

## Filament 4
- Ресурси: app/Filament/Resources/
- Мультимовність: LanguageTabs від filament-language-tabs
- Створення: php artisan make:filament-resource Model --generate --no-interaction

## API Документація (Swagger)
- Пакет: darkaonline/l5-swagger (OpenAPI 3.0)
- URL: /api/documentation
- Генерація: php artisan l5-swagger:generate
- Гайд: docs/api/swagger-guide.md

## Архітектура
- Цей репо — ТІЛЬКИ Backend/API
- Фронтенд — окремий репозиторій

## Правила розробки
1. Перевіряй сусідні файли для конвенцій
2. Використовуй php artisan make:* для генерації
3. Пиши тести для кожної фічі
4. Запускай vendor/bin/pint перед комітом
5. Використовуй Eloquent relationships, не raw queries

Детальніше: див. файл AGENTS.md в корені проекту
</saveart-project-context>
