...
class ArtistController extends AuthorController
{
     ...
     *
     * @OA\Get(
     *     path="/v1/art-ua-info/artists",
     *     operationId="artUaInfoGetArtists",
     *     tags={"Artists"},
     *     summary="Список митців",
     *     description="Повертає список митців (користувачів, які мають опубліковані art-ua-info проєкти)",
     *
     *     @OA\Parameter(name="search", in="query", description="Пошук по імені митця", @OA\Schema(type="string"), example="Іван"),
     *     @OA\Parameter(name="per_page", in="query", description="Кількість на сторінку (макс. 50)", @OA\Schema(type="integer", default=20, maximum=50), example=20),
     *     @OA\Parameter(name="page", in="query", description="Номер сторінки", @OA\Schema(type="integer", default=1), example=1),
     ...
     *
     * @OA\Get(
     *     path="/v1/art-ua-info/artists/{slug}",
     *     operationId="artUaInfoGetArtist",
     *     tags={"Artists"},
     *     summary="Профіль митця",
     *     description="Повертає публічний профіль митця з його даними та соціальними мережами",
     *
     *     @OA\Parameter(name="slug", in="path", required=true, description="Унікальний slug митця", @OA\Schema(type="string"), example="ivan-franko-abc123"),
     *     @OA\Parameter(name="language", in="query", description="Мова відповіді (uk, en)", @OA\Schema(type="string", enum={"uk", "en"})),
     *
     *     @OA\Response(response=200, description="Профіль митця", @OA\JsonContent(@OA\Property(property="data", ref="#/components/schemas/Artist"))),
     *     @OA\Response(response=404, description="Митця не знайдено", @OA\JsonContent(ref="#/components/schemas/ErrorResponse"))
     * )
     */
     ...
     *
     * @OA\Get(
     *     path="/v1/art-ua-info/artists/{slug}/projects",
     *     operationId="artUaInfoGetArtistProjects",
     *     tags={"Artists"},
     *     summary="Проєкти митця",
     *     description="Повертає список публічних art-ua-info проєктів конкретного митця",
     *
     *     @OA\Parameter(name="slug", in="path", required=true, description="Slug митця", @OA\Schema(type="string"), example="ivan-franko-abc123"),
     *     @OA\Parameter(name="status", in="query", description="Фільтр по статусу проєкту", @OA\Schema(type="string", enum={"announced", "in_progress", "completed", "sold"}), example="announced"),
     ...
     *
     * @OA\Get(
     *     path="/v1/art-ua-info/artists/{slug}/photos",
     *     operationId="artUaInfoGetArtistPhotos",
     *     tags={"Artists"},
     *     summary="Портфоліо митця",
     *     description="Повертає список фото з портфоліо митця",
     *
     *     @OA\Parameter(name="slug", in="path", required=true, description="Slug митця", @OA\Schema(type="string")),
     *
