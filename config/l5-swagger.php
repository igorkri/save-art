...
use App\OpenApi\AnnotationAnalyser;
...
return [
        ...
        'art-info' => [
            ...
            'paths' => [
                ...
                'annotations' => [
                    ...
                    base_path('app/Http/Resources/Api/V1/ProjectResource.php'),
                    base_path('app/Http/Resources/Api/V1/ProjectListResource.php'),
                    base_path('app/Http/Resources/Api/V1/ProjectStageResource.php'),
                    base_path('app/Http/Resources/Api/V1/ProjectBonusResource.php'),
                ],
            ],
        ],
    ...
    'defaults' => [
        ...
        'scanOptions' => [
             ...
             * @see scan
             */
            'analyser' => new AnnotationAnalyser,
