...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Фронтенд art-ua-info
    |--------------------------------------------------------------------------
    |
    | Базовий URL вітрини art-ua.info — використовується для посилань у
    | листах (напр. на сторінку послуги в листі про нове замовлення).
    |
    */

    'art_ua_info_frontend_url' => env('ART_UA_INFO_FRONTEND_URL', 'https://art-ua.info'),
