...
<title>Нове замовлення послуги</title>
</head>
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background-color:#272727; border-radius:4px; overflow:hidden;">
        ...
        <tr>
          <td style="padding:24px 32px 8px;">
            <h1 style="margin:0; font-size:22px; line-height:28px; color:#ffffff; font-weight:700;">Нове замовлення послуги</h1>
            <p style="margin:8px 0 0; font-size:15px; line-height:20px; color:#cccccc;">
              Хтось хоче замовити вашу послугу
              ...
              <tr>
                <td style="padding:20px 24px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding:0 0 14px; color:#999999; font-size:13px; line-height:18px;">Ім'я замовника</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="padding:0 0 14px;">
                        <a href="mailto:{{ $customer['email'] }}" style="color:#fecc39; font-size:16px; line-height:22px; text-decoration:none;">{{ $customer['email'] }}</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding:0 0 14px;">
                        <a href="tel:{{ $customer['phone'] }}" style="color:#ffffff; font-size:16px; line-height:22px; text-decoration:none;">{{ $customer['phone'] }}</a>
                      </td>
                    </tr>
                    @endif
                    ...
                    <tr>
                      <td style="padding:0 0 6px; color:#999999; font-size:13px; line-height:18px;">Повідомлення</td>
                    </tr>
                    <tr>
        ...
        <tr>
          <td style="padding:0 32px 28px;">
            <p style="margin:0; color:#777777; font-size:12px; line-height:18px;">
              Лист надіслано автоматично з форми замовлення на
              <a href="{{ $service['url'] }}" style="color:#fecc39; text-decoration:none;">art-ua.info</a>.
              Щоб відповісти замовнику, скористайтесь кнопкою "Відповісти" — лист піде напряму на його пошту.
            </p>
          </td>
        </tr>
      </table>
